...
public final class PdfSessionManager {
     ...
     */
      ...
      //---- PORTAFIB: NOU CODI ------
      //----------------------------------
        final Image rubric = PdfPreProcessor.getImage(extraParams.getProperty(PdfExtraParams.SIGNATURE_RUBRIC_IMAGE), (X509Certificate)certChain[0]);
    ...
    //----------------------------------
    //---- PORTAFIB: Comentat per evitar mostrar di�legs en sistemes Linux sense entorn Gr�fic.
    //----------------------------------
