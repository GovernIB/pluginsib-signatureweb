...
public interface ISignatureWebPlugin extends ISignaturePlugin {
    ...
    public static final String SIGNATUREWEB_BASE_PROPERTY = IPLUGINSIB_BASE_PROPERTIES + "signatureweb.";

    public static final String PLUGINSIB_SIGNATUREWEB_BASE_PROPERTY = IPLUGINSIB_BASE_PROPERTIES + "signatureweb.";
    ...
    /**
     * 
     * @return true Indica que despres de la signatura el sistema pot validar el NIF associat a la firma digital.
     *         false No pot validar el NIF ja que aquest es diferent al que apareix a la firma digital. Aquest darrer cas passa amb les firmes no criptogràfiques 
     */
