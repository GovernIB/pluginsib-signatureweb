...
public class SignatureSIAwithIText {
    ...
    final MiniAppletInServerSIASignatureWebPlugin plugin;
     ...
     */
    public SignatureSIAwithIText(MiniAppletInServerSIASignatureWebPlugin plugin, byte[] certBytes, String hashAlgorithm,
            String encryptionAlgorithm, String callbackURL, String username, String administrationID) {
        super();
        this.plugin = plugin;
    ...
    public class ServerSignature implements ExternalSignature {
        ...
        public byte[] sign(byte[] message) throws GeneralSecurityException {
            ...
            try {
                ...
                StartTransactionResult startT = plugin.startTransacion(certBytes, documents, hashAlgorithm, callbackURL,
                ...
                System.out.println("Quan hagis firmat el document torna a aquesta finestra i pitja Retorn ...");
                System.in.read();
                ...
                System.out.println(" --------  stateTrans.getResult() = ]" + stateTrans.getResult() + "[");
                System.out.println(" --------  stateTrans.getState() = ]" + stateTrans.getState() + "[");
                System.out.println(" --------  stateTrans.getCode_error() = ]" + stateTrans.getCode_error() + "[");
                System.out.println(" --------  stateTrans.getDescription() = ]" + stateTrans.getDescription() + "[");
                ...
                if (!"0".equals(stateTrans.getCode_error())) {
                    ...
                    if (signHash == null) {
                        throw new Exception("No s'ha trobat document amb identificador " + docToSign.getIdData()
                                + " entre les firmes");
                    }
     ...
     * e.printStackTrace(); } }
     */
    public void sign(File src, File dest, Certificate[] chain, CryptoStandard subfilter, String reason, String location,
    ...
    public static void main(String[] args) throws GeneralSecurityException, IOException, DocumentException {
        ...
        try {
            ...
            Certificate[] chain = new Certificate[] {
                    CertificateUtils.decodeCertificate(new ByteArrayInputStream(certBytes)) };
            ...
            SignatureSIAwithIText app = new SignatureSIAwithIText(plugin, certBytes, "SHA-1", "RSA", // RSA =>  OK i  DSA => 
                    "http://www.google.com", username, administrationID);
            app.sign(pdfSource, pdfDest, chain, CryptoStandard.CMS, // CryptoStandard.CADES, => OK
                    null, null, // "Autofirma", "Illes Balears",
                    doc);

            System.out.println("Final. Document Signat guardat a " + pdfDest.getAbsolutePath());
