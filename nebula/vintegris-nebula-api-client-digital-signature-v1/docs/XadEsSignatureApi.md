...
|------------- | ------------- | -------------|
| [**xadesSign**](XadEsSignatureApi.md#xadesSign) | **POST** /api/v2/xadessign/sign | Sign an XML file with XAdES |
...
public class Example {
    public static void main(String[] args) {
        ...
        XadEsSignatureApi apiInstance = new XadEsSignatureApi(defaultClient);
        File _file = new File("/path/to/file"); // File | XML file to sign
        String data = "data_example"; // String | JSON containing the parameters needed to define how the signature will be made. See schema XadesSignatureRequest
        try {
            XadesSignatureResponse result = apiInstance.xadesSign(_file, data);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling XadEsSignatureApi#xadesSign");
...
| **data** | **String**| JSON containing the parameters needed to define how the signature will be made. See schema XadesSignatureRequest | |
