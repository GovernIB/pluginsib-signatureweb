# PadEsDigitalSignatureApi

All URIs are relative to *https://api-ansmt01.nebulaservice.net*

| Method | HTTP request | Description |
|------------- | ------------- | -------------|
| [**signDocumentV1**](PadEsDigitalSignatureApi.md#signDocumentV1) | **POST** /signature/pades/v1/sign | Sign a PDF file |
...
import org.fundaciobit.vintegris.nebula.api.client.digitalsignature.v1.api.PadEsDigitalSignatureApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        PadEsDigitalSignatureApi apiInstance = new PadEsDigitalSignatureApi(defaultClient);
        ...
        try {
            ...
            System.err.println("Exception when calling PadEsDigitalSignatureApi#signDocumentV1");
