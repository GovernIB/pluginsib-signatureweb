...
|------------ | ------------- | ------------- | -------------|
|**userType** | **String** | User type {USER or GROUP} |  [optional] |
|**userId** | **String** | UUID in case userType is USER or GUID in case userType is GROUP |  [optional] |
...
|**enabled** | **String** | True if the policy is enabled |  [optional] |
|**certType** | **String** | Certificate type |  [optional] |
|**idOwner** | **String** | Owner identifier |  [optional] |
|**usePin** | **String** | True if the policy use pin |  [optional] |
